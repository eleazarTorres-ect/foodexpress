...
const ReviewComponent = ({ key, name, stars, message, image }) => {
  ...
  return (
    <div className="flex-wrap content-between w-4/5 h-auto max-w-sm py-5 m-5 overflow-hidden transition duration-150 ease-in-out transform rounded shadow-lg md:py-5 xl:py-10 hover:shadow-xl hover:scale-110">
      <div className="flex flex-wrap justify-center h-32">
        <img className="h-full lg:h-full" src={image} alt={name} />
      </div>
